...
// Родительный падеж названий растений ("цветения чего?")
const PLANT_GENITIVE: Record<string, string> = {
  "Первоцветы": "Первоцветов",
  "Верба (ива)": "Вербы",
  "Ольха": "Ольхи",
  "Лещина": "Лещины",
  "Яблоня": "Яблони",
  ...
  "Клён": "Клёна",
  "Дуб": "Дуба",
  "Одуванчик": "Одуванчика",
  "Клевер луговой": "Клевера лугового",
  "Роза": "Розы",
  "Шалфей": "Шалфея",
  "Чабрец": "Чабреца",
  "Пион": "Пиона",
  "Липа": "Липы",
  "Лаванда": "Лаванды",
  "Тысячелистник": "Тысячелистника",
  "Василёк": "Василька",
  "Подсолнух": "Подсолнуха",
  "Полынь": "Полыни",
  "Гладиолус": "Гладиолуса",
  "Гортензия": "Гортензии",
  "Флокс": "Флокса",
  "Герань": "Герани",
  "Астра": "Астры",
  "Львиный зев": "Львиного зева",
  "Хризантема": "Хризантемы",
  "Георгина": "Георгины",
  "Золотая листва по осени": "Золотой листвы",
  "Форзиция": "Форзиции",
  "Берёза": "Берёзы",
  "Тополь": "Тополя",
  "Сакура": "Сакуры",
...
function getPlantGenitive(name: string): string {
  return PLANT_GENITIVE[name] || name;
}
      ...
      <Container>
        <div className="rounded-2xl bg-white p-6 sm:p-8 shadow-sm">
          <h2 className="text-xl sm:text-2xl font-bold text-text-primary mb-6 text-center">
            Карта цветения {getPlantGenitive(plantName)} по регионам Беларуси
          </h2>
